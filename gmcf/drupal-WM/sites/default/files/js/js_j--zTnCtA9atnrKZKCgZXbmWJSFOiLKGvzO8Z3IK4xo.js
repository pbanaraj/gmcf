	...
	$(document).on("keypress",".per_field",function(e) {
			...
			$('#calc_config_form').validate({
	               ...
	               rules: {
					   ...
					   "YBSP_min_value" : {required : true,maxV:'#LT_default_value'},
					   "YBSP_max_value" : {required : true,greaterThan1: '#YBSP_min_value',maxV: '#LT_default_value'},
	               ...
	               messages: {					   
					   ...
					   "YBSP_min_value" : {required : "Please provide a valid value.",maxV:"Max value should not be more than loan term"},
					   "YBSP_max_value" : {required : "Please provide a valid value.",greaterThan1: "The maximum value should be more than min value",maxV: "Max value should not be more than loan term"},
