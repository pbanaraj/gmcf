	...
	$(document).on("keypress","#IR_default_value",function(e) {
			...
			$('#calc_config_form').validate({
	               ...
	               rules: {
					   ...
					   "DP_min_value": {required : true,min_greaterThan: '#HM_max_value'},
					   "DP_max_value": {required : true,max_lessThan1: '#HM_max_value',greaterThan1: '#DP_min_value'},
					   ...
					   "HOA_default_value" : {required : true,lessThan1: '#LA_default_value'},
					   ...
					   "MR_default_value" : {required : true,min:1,max: 999999999},
					   "AHA_default_value" : {required : true,min:1,max: 99},
					   "ME_default_value" : {required : true,lessThan1: '#HM_default_value'},
					   ...
					   /*"HM_max_value": {required : true,max: 999999999},
					   "HM_max_value": {required : true,max: 999999999},
					   "HM_max_value": {required : true,max: 999999999},
					   "HM_max_value": {required : true,max: 999999999},
					   "HM_max_value": {required : true,max: 999999999},
	               ...
	               messages: {					   
					   "HM_min_value": {required : "Please provide a valid value.",min:1,max:"The home value should not be more than 999999999."},
					   "HM_max_value": {required : "Please provide a valid value.",min:1,max:"The home value should not be more than 999999999.",greaterThan1: "The maximum value cannot be less than min value"},
					   "HM_default_value": {required : "Please provide a valid value.",min:1,greaterThan: "Default value cannot be less than min value",lessThan: "Default value cannot be more than max value"},
					   "LA_min_value": {required : "Please provide a valid value.",min:1,max_lessThan: "Max value cannot be more than 97% of home value"},
					   ...
					   "HOA_default_value" : {required : "Please provide a valid value.",lessThan1: "HOA cannot be more than loan amount"},
					   ...
					   "MR_default_value": {required : "Please provide a valid value.",max:"Max value cannot be more than 999999999."},
					   "AHA_default_value": {required : "Please provide a valid value.",max:"Max value cannot be more than 99."},
					   "ME_default_value" : {required : "Please provide a valid value.",lessThan1: "Monthly Expenses cannot be more than home value."},
					   ...
					   /*"HM_max_value": {required : "Please provide a valid value.",max:"The home value should not be more than 999999999."},
					   "HM_max_value": {required : "Please provide a valid value.",max:"The home value should not be more than 999999999."},
					   "HM_max_value": {required : "Please provide a valid value.",max:"The home value should not be more than 999999999."},
					   "HM_max_value": {required : "Please provide a valid value.",max:"The home value should not be more than 999999999."},
					   "HM_max_value": {required : "Please provide a valid value.",max:"The home value should not be more than 999999999."},
